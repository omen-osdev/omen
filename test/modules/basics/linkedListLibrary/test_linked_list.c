...
static void setup_items(struct list_item **items, size_t num_items) {
...
static void setup_list_with_items(struct list_head *list, size_t num_items) {
  INIT_LIST_HEAD(list);
...
static void setup_list_and_items(struct list_head *list,
                                 struct list_item **items, size_t num_items) {
  INIT_LIST_HEAD(list);
  TEST_ASSERT_TRUE(list_empty(list));
...
static void test_list_splice_tail_init(void) {
  struct list_head list, list2;
  struct list_item *item, *is;
...
static void test_list_first_entry(void) {
  struct list_head list;
  struct list_item *items;
...
static void test_list_last_entry(void) {
  struct list_head list;
  struct list_item *items;
