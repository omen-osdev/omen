...
#include <omen/modules/managers/boot/bootloaders/limine/limine_requests.h>
...
struct bootloader_operations limine_boot_ops = {
    .get_boot_time = (boot_operation_t)_get_boot_time,
    .get_bootloader_name = (boot_operation_t)_get_bootloader_name,
    .get_bootloader_version = (boot_operation_t)_get_bootloader_version,
    .get_current_terminal = (boot_operation_t)_get_current_terminal,
    .get_framebuffer_count = (boot_operation_t)_get_framebuffer_count,
    .get_framebuffers = (boot_operation_t)_get_framebuffers,
    .get_kernel_address_physical = (boot_operation_t)_get_kernel_address_physical,
    .get_kernel_address_virtual = (boot_operation_t)_get_kernel_address_virtual,
    .get_memory_map_base = (boot_operation_t)_get_memory_map_base,
    .get_memory_map_entries = (boot_operation_t)_get_memory_map_entries,
    .get_memory_map_length = (boot_operation_t)_get_memory_map_length,
    .get_memory_map_type = (boot_operation_t)_get_memory_map_type,
    .get_rsdp_address = (boot_operation_t)_get_rsdp_address,
    .get_smbios32_address = (boot_operation_t)_get_smbios32_address,
    .get_smbios64_address = (boot_operation_t)_get_smbios64_address,
    .get_smp_bsp_lapic_id = (boot_operation_t)_get_smp_bsp_lapic_id,
    .get_smp_cpu_count = (boot_operation_t)_get_smp_cpu_count,
    .get_smp_cpus = (boot_operation_t)_get_smp_cpus,
    .get_smp_flags = (boot_operation_t)_get_smp_flags,
    .get_terminal_count = (boot_operation_t)_get_terminal_count,
    .get_terminal_writer = (boot_operation_t)_get_terminal_writer,
    .set_terminal_extra_handler = (boot_operation_t)_set_terminal_extra_handler,
    .set_terminal_writer = (boot_operation_t)_set_terminal_writer
};
